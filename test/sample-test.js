...
describe("EarnestroiMarketPlace", function () {
  ...
  beforeEach(async function () {
    ...
    NFT = await ethers.getContractFactory("EarnestroiNFT");
    Marketplace = await ethers.getContractFactory("EarnestroiMarketPlace");
  ...
  describe("Deployment", function () {
    ...
    it("Should track name and symbol of the nft collection", async function () {
      ...
      const nftName = "Earnestroi NFT"
      const nftSymbol = "ENFT"
